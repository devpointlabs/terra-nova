...
5.times do
  Room.create(
    ...
    cost: 300,
    max_occupancy: 6,
    description: "Located in the heart of Aspen with a unique blend of contemporary luxury and historic heritage, deluxe accomodations supurb amenities, genuine hospitality and dedicated service for an elevated experience in the Rocky Mountains.",
    size: "600 Square Feet",
    view: "Lake View",
    image: "../public/assets/exterior2.jpg",
...
5.times do
  Room.create(
    ...
    view: "Forest View",
    image:"../public/assets/exterior1.jpg", 
...
5.times do
  Room.create(
    ...
    size: "600 Square Feet",
    view: "Park View",
    image: "../public/assets/interior.jpg",
    bed_type: "King or Queen and two Twin Beds",
    )
end   
